...
import br.com.vendas.dto.VendaDTO;
...
import br.com.vendas.service.IProdutoService;
...
public class CadastroVenda {
	...
	private Venda convertToDomain(@Valid VendaDTO vendaDTO, Status status) {
		...
		Venda venda = new Venda(vendaDTO.getCodigo(),vendaDTO.getClienteId(),BigDecimal.ZERO,vendaDTO.getDataVenda(),status);
		return venda;
