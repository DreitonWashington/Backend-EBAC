...
public class Venda {
	...
	public Venda(String codigo, @NotNull String clienteId,
			BigDecimal valorTotal, @NotNull Instant dataVenda,
	...
	public void adicionarProduto(Produto produto, Integer quantidade) {
		...
		if (op.isPresent()) {
			...
			ProdutoQuantidade prod = new ProdutoQuantidade(produto,quantidade, BigDecimal.ZERO);
